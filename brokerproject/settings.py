"""
Django settings for brokerproject project.
...
SECRET_KEY = 't3l0s%w1d_6f9=$w6dlvw@@#gpm#w@^1abu6rf85=5tw9e5(f9'
...
INSTALLED_APPS = [
    'broker_app.apps.BrokerAppConfig',
...
WSGI_APPLICATION = 'brokerproject.wsgi.application'
...
AWS_ACCESS_KEY_ID = 'AKIAI7PXOILKBY5JS5LA'
AWS_SECRET_ACCESS_KEY = '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'
