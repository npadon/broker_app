# Generated by Django 2.0.4 on 2018-06-02 17:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='broker_app.Building')),
                ('created_by', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_type', models.CharField(choices=[('Floorplan', 'Floorplan'), ('Image', 'Image')], default='Image', max_length=15)),
                ('upload', models.FileField(upload_to='')),
                ('landlord_response', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='broker_app.LandlordResponse')),
            ],
        ),
        migrations.CreateModel(
            name='Requirement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('landlord_reponses', models.ManyToManyField(to='broker_app.LandlordResponse')),
            ],
        ),
        migrations.AddField(
            model_name='landlordresponse',
            name='requirement',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='broker_app.Requirement'),
        ),
    ]
